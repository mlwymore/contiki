...
/** Joris: added #if WILAB header */

#ifdef WILAB
#define TINYOS_SERIAL_FRAMES
/* defaults given by wilab.h
 * XXX we shouldn't have to replicate that here, should we ? */
#define AM_WILAB_CONTIKI_PRINTF     65
#define SERIAL_FRAME_SIZE_CONF     100
#endif

/** end of changes for this version **/
...
#define NETSTACK_CONF_RDC     xmac_driver //  contikimac_driver
#define NETSTACK_CONF_RADIO   cc2420_driver
