...
<simconf>
  ...
  <simulation>
    ...
    <radiomedium>
      ...
      <transmitting_range>60</transmitting_range>
      <interference_range>72</interference_range>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/lpprdc/tree-static/example-collect.c</source>
      <commands EXPORT="discard">make example-collect.z1 TARGET=z1</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/lpprdc/tree-static/example-collect.z1</firmware>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>/* Begin script */
TIMEOUT(381000, log.append(filename, plugin.radioStatistics());)

plugin = mote.getSimulation().getCooja().getStartedPlugin("PowerTracker");

filename = "/home/user/git/contiki/examples/lpprdc/tree-static/cooja-results/" + 
