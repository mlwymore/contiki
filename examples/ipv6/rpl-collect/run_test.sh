...
AUX_DIRECTORY="/home/user/git/contiki/examples/ipv6/rpl-collect"
...
SOURCE_APP="udp-sender"
SINK_APP="udp-sink"
SOURCE_FILE_PATH="$AUX_DIRECTORY/collect-common.c"
CSC_LIST=("$AUX_DIRECTORY/collect-tree-dense-noloss-z1.csc")
PROJ_CONF_DIR=$AUX_DIRECTORY
PROJ_CONF_LIST=("project-conf.h")
PROTOCOL_LIST=("lpprdc" "lpprdc" "lpprdc" "contikimac" "contikimac")
OPP_CONF_LIST=(0 0 0 0 0)
CCR_LIST=(1 2 4 8 16)
